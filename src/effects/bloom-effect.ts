...
export class BloomEffect {
  ...
  private screneTextureBindGroup!: GPUBindGroup;
  ...
  constructor(private device: GPUDevice, public width: number, public height: number) {}

  public async initialize() {
    this.sceneTexture = await Texture.createEmptyTexture(this.device, this.width, this.height, "bgra8unorm");
    this.brightnessTexture = await Texture.createEmptyTexture(this.device, this.width, this.height, "bgra8unorm");
    ...
    this.screneTextureBindGroup = this.device.createBindGroup({
  ...
  public draw(destinationTextureView: GPUTextureView) {
    ...
    passEncoder.setBindGroup(0, this.screneTextureBindGroup);
