...
export class SpriteFontChar {
  constructor(public textureCoords: Quad, public size: vec2, public advance: number, public offset: vec2) {}
}

export class SpriteFont {
  private chars: { [id: number]: SpriteFontChar } = {};

  constructor(public readonly texture: Texture, public readonly lineHeight: number) {}
