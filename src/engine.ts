...
import { EffectsFactory } from "./effects/effects-factor";
...
export class Engine {
  ...
  public setDestinationTexture(texture?: GPUTexture | null): void {
    this.destinationTexture = texture;
  }

  public setDestinationTexture2(texture: GPUTexture | null): void {
  ...
  public draw(): void {
    ...
    const textureView = this.destinationTexture != null ? this.destinationTexture.createView() : this.context.getCurrentTexture().createView();
